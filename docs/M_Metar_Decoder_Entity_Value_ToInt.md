...
Convert a string value into an int, and takes into account some non-numeric char P = +, M = -, / = null
...
#### Parameters
<dl><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a></dt><dd>\[Missing &lt;param name="value"/&gt; documentation for "M:Metar.Decoder.Entity.Value.ToInt(System.String)"\]</dd></dl>
...
\[Missing &lt;returns&gt; documentation for "M:Metar.Decoder.Entity.Value.ToInt(System.String)"\]
