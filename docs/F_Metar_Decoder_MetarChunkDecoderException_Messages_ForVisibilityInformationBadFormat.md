...
\[Missing &lt;summary&gt; documentation for "F:Metar.Decoder.MetarChunkDecoderException.Messages.ForVisibilityInformationBadFormat"\]
...
**C#**
``` C#
public const string ForVisibilityInformationBadFormat = "Bad format for visibility information"
```
