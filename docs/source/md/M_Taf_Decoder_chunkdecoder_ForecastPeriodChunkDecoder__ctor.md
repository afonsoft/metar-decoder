# ForecastPeriodChunkDecoder Constructor


Initializes a new instance of the <a href="T_Taf_Decoder_chunkdecoder_ForecastPeriodChunkDecoder.md">ForecastPeriodChunkDecoder</a> class
...
**C#**
``` C#
public ForecastPeriodChunkDecoder()
```
