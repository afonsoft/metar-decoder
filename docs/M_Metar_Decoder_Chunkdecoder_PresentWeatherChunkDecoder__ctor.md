# PresentWeatherChunkDecoder Constructor


Initializes a new instance of the <a href="T_Metar_Decoder_Chunkdecoder_PresentWeatherChunkDecoder.md">PresentWeatherChunkDecoder</a> class
...
**C#**
``` C#
public PresentWeatherChunkDecoder()
```
